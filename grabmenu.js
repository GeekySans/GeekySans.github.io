...
function loadmenu() {
menu = [
"<h1>GeekySans's Digital Playground</h1>", "<h1>" + greeting + "</h1>",
"<div> <a href='/home'><button class='home'>Home</button></a> <a href='https://spacehey.com/profile?id=2706928'><button class='spacehey'>Spacehey</button></a> <a href='https://nerdie-board.forumotion.com/'><button class='forum'>Forum</button></a> <a href='/blogs'><button class='blogs'>Blogs</button></a> <a href='/games'><button class='games'>Games</button></a> <a href='/posts'><button class='posts'>Posts</button></a> </div>",
